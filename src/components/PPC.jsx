  ...
  return (
    ...
    <div className='flex flex-col gap-8'>
      ...
      <div className='flex gap-4'>
        <input onChange={handleEmailChange} className='w-[350px] h-[80px] border-2 border-solid rounded-md px-4 py-2' type="email" name="email" id="email" placeholder='Enter your work email' />
        <button className='bg-blue-700 px-24 text-xl rounded-md text-white hover:bg-blue-900'>Subscribe</button>
      </div>
